...
public:
	...
	void computeShaderSkyShiftNight();
	void computeShaderSkyShiftDay();
...
private:
	...
	Microsoft::WRL::ComPtr<ID3D11UnorderedAccessView> unorderedAccessViewCubemap;

	Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> nightSkyTextures[6] = {};

	Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> daySkyTextures[6] = {};

	Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> currentTextures[6] = {};

	float currentTextureInterpolation = 0.0f;
	...
	float skyDeltaTime = 0;
	bool interoplatingToNewTexture = true;
