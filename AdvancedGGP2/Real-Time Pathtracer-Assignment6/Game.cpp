...
void Game::Init()
{
	...
	material1 = std::make_shared<Material>(pipelineState, XMFLOAT3(0.3f, 0.0f, 1.0f), uvScale, uvOffset,1.0f);
	...
	material2 = std::make_shared<Material>(pipelineState, XMFLOAT3(0, 0.2, 0.7), uvScale, uvOffset, 0.0f);
	...
	material3 = std::make_shared<Material>(pipelineState, XMFLOAT3(0, 0.5, 0), uvScale, uvOffset, 0.5f);
	...
	material4 = std::make_shared<Material>(pipelineState, XMFLOAT3(0.5, 0.5, 0), uvScale, uvOffset, 0.0f);
	...
	material5 = std::make_shared<Material>(pipelineState, XMFLOAT3(0.2, 0.5, 0.75), uvScale, uvOffset, 0.8f);
